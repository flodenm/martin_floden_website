# EC2211 Lecture Notes 4: Ideas, Institutions, and Long-Run Growth
...
Suppose that productivity grows at the constant rate $g_A$. Applying the growth-rate rules to the Malthusian per-capita production equation gives $$g_y=g_A-\lambda g_L.$$

Along a balanced growth path, the Malthusian population equation implies that the population growth factor – and therefore income per person – must be constant: $$g_y=0.$$ It follows that $$g_L=\frac{g_A}{\lambda}.$$
...
Divide the Romer goods-production equation by $L_t$ and use $L_{yt}=(1-\lambda)L_t$: $$
        y_t\equiv\frac{Y_t}{L_t}
        =A_t^\gamma(1-\lambda).$$
...
Divide the Romer idea-production equation by $A_t$: $$
...
On a balanced growth path, $g_A$ is constant. Rearranging the knowledge-growth equation gives $$A_t=\frac{\zeta\lambda}{g_A}L_t.$$
...
From the per-capita output equation, $$y_t=A_t^\gamma(1-\lambda).$$ Since $1-\lambda$ is constant, the growth-rate rules give $$g_y=\gamma g_A.$$ Using $g_A=n$ on the balanced growth path, $$
        \boxed{g_y=\gamma n.}$$
...
Suppose that research productivity $\zeta$ rises permanently. From the knowledge-growth equation, $$g_{At}=\zeta\lambda\frac{L_t}{A_t}.$$
...
**Figure source:** `TFR_a.png`

**Figure description:** Total fertility rates from 1960 to the early 2020s for Sweden, the United States, Germany, Italy, and Japan. Fertility generally declines and is below replacement near the end, with especially low rates in Italy and Japan and cyclical variation in Sweden and the United States.

**Figure source:** `TFR_b.png`

**Figure description:** Total fertility rates over the same period for Korea, China, Nigeria, India, and Egypt. Fertility declines in every country, extraordinarily sharply in Korea and China; Nigeria remains much higher but also trends downward.
...
North and Thomas (1973), "The Rise of the Western World"
