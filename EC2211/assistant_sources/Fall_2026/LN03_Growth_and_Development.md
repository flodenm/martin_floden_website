# Lecture Notes 3: Growth and Development in the Solow Model
...
**Figure description:** Cross-country scatterplot for 2019 showing a strong positive association between capital per capita and output per capita. Rich countries generally have more capital per person, but the graph alone does not establish causation or show whether capital fully explains income differences.
...
| Item | PISA 2025 | Change since 2022 |
| --- | --- | --- |
| Reading | 466 | $-21$ |
| Mathematics | 464 | $-18$ |
| Science | 485 | $-8$ |
...
**Figure description:** Worldwide version of the convergence scatterplot for 1960–2019. The data are far more dispersed than for the OECD; some poor countries grew rapidly, while others stagnated or contracted. Unconditional convergence is weak across the full world sample.

Figure 5.9 in Jones (2024).

### Average convergence hides growth miracles and disasters

**Figure source:** `GrowthMiraclesDisasters.pdf`
...
What determines whether output per person can continue to grow when one productive input is fixed or gradually disappears?
