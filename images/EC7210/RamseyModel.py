...
# =========================================================
# 2. Find transition to steady state
# =========================================================
...
# =========================================================
# k(1) = k0, k(2..T) = exp(x_sol[0:T-1])
k = np.empty(T + 1)
k[0] = k0
k[1:T] = np.exp(x[0 : T - 1])
...
# c' = c locus is just vertical line at k_ss
plt.plot([kss, kss], [0, 2 * css], color="black", linewidth=2, label="\Delta c = 0")
